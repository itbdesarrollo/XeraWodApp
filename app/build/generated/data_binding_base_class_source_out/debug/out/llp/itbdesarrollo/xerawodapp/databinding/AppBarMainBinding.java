...
public final class AppBarMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Toolbar toolbarUp;

  private AppBarMainBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbarUp) {
    this.rootView = rootView;
    this.toolbarUp = toolbarUp;
  }
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.toolbarUp;
      Toolbar toolbarUp = ViewBindings.findChildViewById(rootView, id);
      if (toolbarUp == null) {
        break missingId;
      }

      return new AppBarMainBinding((CoordinatorLayout) rootView, toolbarUp);
    }
